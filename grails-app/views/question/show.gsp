	...
	<body>
		...
		<div id="show-question" class="content scaffold-show" role="main">
			...
			<ol class="property-list question">
				...
				<g:if test="${questionInstance?.mark}">
				<li class="fieldcontain">
					<span id="mark-label" class="property-label"><g:message code="question.mark.label" default="Mark" /></span>
					
						<span class="property-value" aria-labelledby="mark-label"><g:fieldValue bean="${questionInstance}" field="mark"/></span>
