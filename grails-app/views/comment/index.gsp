		...
		<div id="list-comment" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="mark" title="${message(code: 'comment.mark.label', default: 'Mark')}" />
				...
				<g:each in="${commentInstanceList}" status="i" var="commentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${commentInstance.id}">${fieldValue(bean: commentInstance, field: "mark")}</g:link></td>
